...
-(id)initWithFrame:(CGRect)frame {
  ...
  // Return the preprocessed button
  return btn;
}
%end
...
%ctor {
  ...
  if (IOS_VER_GT_EQ(13.0)) {
    %init(iOS13, AppStoreOfferButton = objc_getClass("AppStore.OfferButton"));
  } else {
    %init(iOS12, AppStoreOfferButton = objc_getClass("AppStore.OfferButton"));
  }
}